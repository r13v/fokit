	...
	},
	{
		toMarkdown() {
			return markdownFallback(
				"The live async multiselect runs only in a browser. It stores selected IDs in Form, Please, loads matching options through TanStack Query, and manages the popup with Floating UI.",
